package com.amirhusseinsoori.mvi_persian_dictinary.ui.theme
...
@Composable
fun ProvideDicColors(
    colors: DictionaryColors,
    content: @Composable () -> Unit
) {
...
class DictionaryColors(
    ...
    fun update(other: DictionaryColors) {
    ...
    fun copy(): DictionaryColors = DictionaryColors(
